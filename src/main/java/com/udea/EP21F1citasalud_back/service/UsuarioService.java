...
public class UsuarioService {
    ...
    /**
     * inicio de sesión de un usuario con correo y contraseña
     * @param email email del usuario
     * @param password password del usuario
     * @return un UserDTO con la información del usuario autenticado
     */
    @Transactional(readOnly = true)
    public UsuarioDTO login(String email, String password) {
        ...
        Usuario usuario = userRepository.findByEmail(email).orElseThrow(() -> new IllegalArgumentException("Invalid email"));
